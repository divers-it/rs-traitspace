...
* Angiosperms have an exceptional diversity of breeding systems
  ...
  + obligate outcrossing to selfing
* Breeding systems are highly labile and impact many ecological & evolutionary processes
* Simple associations are known between breeding system traits 
  + e.g. selfing + short life span or dioecy + tree form
:::
...
* Can we use multi-trait approaches to identify more integrated reproductive strategies?
  ...
  + Inspired by Grime's CSR theory
* Combinations of traits can influence patterns species diversification (Helmstetter et al. 2023, Anderson et al. 2023)
:::

## Introduction

::: {.incremental}
* Such approaches are commonly used in functional ecology but less so in evolutionary biology.
* Evolutionary perspectives are not often taken in functional ecology studies
* From a static to a dynamic viewpoint
  + Not just fitness in a given environment but the product of a dynamic macroevolutionary process
:::
...
::: {.incremental}
* We fit OU / Mk models to each of our traits
...
::: {.incremental}
* Alongside woodiness, traits relating to sexual system play a defining role
  + Dimorphic species are distinct!
* Three major 'Eco-evolutionary strategies'?
* Reproductive traits provide a new dimension to traditional plant functional ecology
:::
