...
##  Remove cluster assignment for non-robust species
robust<- readRDS(file = here::here("outputs/10_robust_vect_pam_full.rds"))

metadata$cluster[is.na(robust)] <- NA
