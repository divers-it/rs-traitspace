...
####
# Figure S14: Scatterplot PAM with robust groups showing unisexual, abiotic outliers ----
####
...
ggsave("figures/figure_S14_pcoa_pam_coloured_by_robust.png",width=12,height=10)
