...
c1d2_fix <- ( d2 / c1 ) + plot_layout(heights=c(1, 4))
c1d2_fix

# layout
layout <- c(
area(t = 1, l = 1, b = 100, r = 100),
area(t = 1, l = 110, b = 99, r = 170)
)
...
#### 
## Figure S7: Loadings scatterplot without cluster Axes 3 and 4 ----
#### 
...
ggsave("figures/figure_S7_loadings_axes_3_4.png",
       #height=12.5*yax,
       height=12.5,
       width=12.5)
