# Impute missing data using phylogenetic information
...
####
## Simulate missing data in original encoding ----
#### 
...
# write standard csv
write.csv(phy_imp_df,"outputs/one_hot_imputed_with_phylo.csv")
