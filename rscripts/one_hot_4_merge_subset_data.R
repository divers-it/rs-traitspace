...
#load discrete data
disc_df<-read.csv("outputs/one_hot_1_proteus_discrete_recoded.csv",row.names = 1)
head(disc_df)
...
qr_df<-read.csv("outputs/one_hot_3_proteus_quant_recoded.csv",row.names = 1)
head(qr_df)
...
#write output csv
write.csv(proteus_combined,"outputs/one_hot_4_proteus_combined.csv")
