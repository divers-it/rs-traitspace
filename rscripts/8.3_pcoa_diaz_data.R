...
#set colours
#mypal <- c("#A9A9A9",ochRe::ochre_pal("winmar")(8)[4])
#mypal <- c("#A9A9A9",ochRe::ochre_pal("namatjira_div")(8)[2])
...
ggsave("figures/8.3_scatterplot_lineplot_diaz_vs_divers.png",width=10,height=15)
