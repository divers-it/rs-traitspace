...
#k=4
protClust <- findClusters(protClust, rho = 25,delta = 0.1,verbose = FALSE,plot = TRUE)
...
#save image
ggsave("figures/one_hot_11.4_scatterplot_pcoa_dens_k4_coloured_by_cluster.png",width = 12,height=10)
...
saveRDS(clust.num.k.2.7.df, file = here::here("outputs/one_hot_11.4_clust_num_k_2_7_density.rds"))
...
#save as html
saveNetwork(p, "figures/one_hot_11.4_sankey_dens.html")
...
saveRDS(robust_vect_dens_full, file = here::here("outputs/one_hot_11.4_robust_vect_dens_full.rds"))
...
pdf("figures/one_hot_11.4_boxplots_stacked_barplots_dens_clusters_by_trait.pdf",width = 15,height = 15)
...
#save image
ggsave("figures/one_hot_11.4_stacked_barplots_dens_traits_by_cluster.png",width=15,height=10)
