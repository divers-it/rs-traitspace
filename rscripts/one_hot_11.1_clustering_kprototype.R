...
#save plot
ggsave("figures/one_hot_11.1_scatterplot_pcoa_kpro_k4_coloured_by_cluster.png",width = 12,height=10)
...
saveRDS(clust.num.k.2.7.df, file = here::here("outputs/one_hot_11.1_clust_num_k_2_7_kpro.rds"))
...
#save as html
saveNetwork(p, "figures/one_hot_11.1_sankey_kpro.html")
...
saveRDS(robust_vect_kpro_full, file = here::here("outputs/one_hot_11.1_robust_vect_kpro_full.rds"))
...
#save plot
ggsave("figures/one_hot_11.1_scatterplot_pcoa_kpro_k3_coloured_by_robust.png",width=12,height=10)
...
pdf("figures/one_hot_11.1_boxplots_stacked_barplots_kpro_clusters_by_trait.pdf",width = 15,height = 15)
...
#save plot
ggsave("figures/one_hot_11.1_stacked_barplots_kpro_traits_by_robust.png",width=15,height=10)

#save image as takes long to run
save.image(file = "outputs/one_hot_11.1_kpro.RData")
