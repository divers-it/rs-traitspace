...
saveRDS(ou_list,"outputs/14_ou_list.rds")
...
saveRDS(mk_list,"outputs/14_mk_list.rds")
...
ou_list <- readRDS("outputs/14_ou_list.rds")
mk_list <- readRDS("outputs/14_mk_list.rds")
n_sim <- 1000
set.seed(123)
simdata <- replicate(n_sim,simul_dataset(ou_list,mk_list,angio_tree),simplify = F)
saveRDS(simdata,"outputs/14_phylo_simulated_datasets.rds")
...
sim_list <- readRDS("outputs/14_phylo_simulated_datasets.rds")
...
saveRDS(data.frame(t(sim_ev)),"outputs/14_phylo_simulated_ev.rds")

# read in previously calculated eigenvalues
sim_ev <- readRDS("outputs/14_phylo_simulated_ev.rds")
...
ggsave("figures/figure_S6_eigenvalues_simulations.png",width=10,height=10)
...
# ggsave("figures/14_pcoa_sim_ex1.png")
...
ggarrange(plotlist = list(g1,g2),ncol = 1,nrow = 2)
# ggsave("figures/14_pcoa_sim_ex2.png")
...
ggarrange(plotlist = list(g1,g2),ncol = 1,nrow = 2)
# ggsave("figures/14_pcoa_sim_ex3.png")
...
png("figures/figure_S2_scatterplots_pairwise_distances.png",width=1500,height=1500,res=100)
