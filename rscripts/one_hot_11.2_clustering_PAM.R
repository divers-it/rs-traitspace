...
#save image
ggsave("figures/one_hot_11.2_scatterplot_tsne_pam_k5_coloured_by_cluster.png",width=12,height=10)
...
ggsave("figures/one_hot_11.2_scatterplot_pcoa_pam_k5_coloured_by_cluster.png",width=12,height=10)
...
#save RDS
saveRDS(clust.num.k.2.7.df, file = here::here("outputs/one_hot_11.2_clust_num_k_2_7_pam.rds"))
...
#save as HTML
saveNetwork(p, "figures/one_hot_11.2_sankey_pam.html")
...
saveRDS(robust_vect_pam_full, file = here::here("outputs/one_hot_11.2_robust_vect_pam_full.rds"))
...
ggsave("figures/one_hot_11.2_scatterplot_pcoa_pam_coloured_by_robust.png",width=12,height=10)
...
#save plot
ggsave("figures/one_hot_11.2_scatterplot_tsne_pam_coloured_by_robust.png",width=12,height=10)
