...
#load formatted data
df<-readRDS(file = here::here("outputs/one_hot_5_df_filt.rds"))
...
pdf("figures/one_hot_6_proteus_trait_hists_one_hot.pdf")
par(mfrow=c(3,3))
#look at hists
for(i in 1:7){
...
pdf("figures/one_hot_6_proteus_trait_hists_transformed_one_hot.pdf")
par(mfrow=c(3,3))
...
#plot histograms of logged (log10) variables
pdf("figures/one_hot_6_proteus_trait_hists_transformed_scaled_one_hot.pdf")
par(mfrow=c(3,3))
...
saveRDS(df2, file = here::here("outputs/one_hot_6_df_filt_trans.rds"))
