...
#save plot
ggsave("figures/8.1_scatterplot_pcoa_no_repro.png",
       width = 20,
       height = 15,
       units = 'cm')
...
ggsave("figures/8.1_barplot_relative_eigenvalues_pcoa_no_repro.png")
...
#save
ggsave("figures/8.1_scatterplot_pcoa_coloured_by_traits_no_repro.png",
       width = 30,
       height = 15,
       units = 'cm')
