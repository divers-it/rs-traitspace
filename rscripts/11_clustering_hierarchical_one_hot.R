...
wk3 + wk5
ggsave("figures/dendro_ward_one_hot.png",
       width = 10,
       height = 10)
...
#save image
ggsave("figures/pcoa_hclust_one_hot_k5.png",
       width = 12,
       height = 10)
...
ggsave("figures/pcoa_hclust_one_hot_k3.png",
       width = 12,
       height = 10)
...
pdf("figures/clusters_by_trait_ward_one_hot.pdf",width = 15,height = 15)
