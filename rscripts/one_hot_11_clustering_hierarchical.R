...
#running and plot different methods to compare results
...
wk3 + wk5
ggsave("figures/one_hot_11_dendrograms_ward2_coloured_by_cluster.png",
       width = 10,
       height = 10)
...
#save image
ggsave("figures/one_hot_11_scatterplot_pcoa_wardD2_k5_coloured_by_cluster.png",
       width = 12,
       height = 10)
...
saveRDS(clust.num.k.2.7.df, file = here::here("outputs/one_hot_11_clust_num_k_2_7_ward.rds"))
...
#save as html
saveNetwork(p, "figures/one_hot_11_sankey_ward.html")
...
#add label to group
df_labelled<-cbind(df,clust.num.k.2.7.df$`5clusters`)
...
pdf("figures/one_hot_11_boxplots_stacked_barplots_wardD2_clusters_by_trait.pdf",width = 15,height = 15)
...
#save plot 
ggsave("figures/one_hot_11_stacked_barplots_wardD2_traits_by_cluster.png",width=15,height=10)
