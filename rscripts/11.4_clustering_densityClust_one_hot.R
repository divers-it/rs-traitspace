...
#save image
ggsave("figures/scatterplot_pcoa_dens_one_hot.png",width = 12,height=10)
...
saveRDS(clust.num.k.2.7.df, file = here::here("outputs/clust_num_k_2_7_density_one_hot.rds"))
...
#save as html
saveNetwork(p, "figures/sankey_density_one_hot.html")
...
saveRDS(robust_vect_dens_full, file = here::here("outputs/robust_vect_dens_full_one_hot.rds"))
...
pdf("figures/clusters_by_trait_dens_one_hot.pdf",width = 15,height = 15)
...
#save plot
ggsave("figures/stacked_barplots_traits_by_cluster_dens_one_hot.png",width=15,height=10)
