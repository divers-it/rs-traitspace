...
#
protClust <- findClusters(protClust, rho = 26,delta = 0.5,verbose = FALSE,plot = TRUE)
...
rho_v<-c(43,42,34,30,28,26)
delta_v<-c(0.6,0.6,0.6,0.6,0.55,0.5)
...
pdf("figures/robust_dens_plots_one_hot.pdf",width = 15,height = 15)
