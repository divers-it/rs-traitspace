...
df_recoded <- readRDS("outputs/14_imputed_recoded.rds")
...
saveRDS(ou_list,"outputs/15_ou_list.rds")
...
saveRDS(mk_list,"outputs/15_mk_list.rds")
...
ou_list <- readRDS("outputs/15_ou_list.rds")
mk_list <- readRDS("outputs/15_mk_list.rds")
n_sim <- 1000
set.seed(123)
...
sim_list <- readRDS("outputs/15_phylo_simulated_datasets.rds")
...
saveRDS(data.frame(t(sim_ev)),"outputs/15_phylo_simulated_ev.rds")

# read in previously calculated eigenvalues
sim_ev <- readRDS("outputs/15_phylo_simulated_ev.rds")
...
# ggsave("figures/15_pcoa_sim_ex1.png")
...
ggarrange(plotlist = list(g1,g2),ncol = 1,nrow = 2)
# ggsave("figures/15_pcoa_sim_ex2.png")
...
ggarrange(plotlist = list(g1,g2),ncol = 1,nrow = 2)
# ggsave("figures/15_pcoa_sim_ex3.png")
