...
![Fig. Pairwise relationships between different
traits](./figures/ggpairs.png)
...
This was just one method of clustering, other methods that can deal with
mixed and missing data include
[kprototypes](https://journal.r-project.org/archive/2018/RJ-2018-048/RJ-2018-048.pdf),
[model-based clustering](https://varsellcm.r-forge.r-project.org/) and
[Partitioning Around
Medoids](https://dpmartin42.github.io/posts/r/cluster-mixed-types)
(PAM).
