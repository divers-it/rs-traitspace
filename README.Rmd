...
![Fig. Missingness plot showing the missing data per trait in black.](figures/missing_data.png){width=100%}
...
![Fig. Visualization of gower distances where red means closer and blue further away](./figures/proteus_fviz_dist.png){width=100px}
...
![Fig. Within cluster sum of squares for increasing numbers of clusters.](./figures/silwidth_ward.png){width=50%} <!-- .element height="50%" width="50%" -->
...
![Fig. The relative proportion for qualitative traits across clusters (k = 3)](./figures/hclust_characteristics_qual.png){width=75%}
