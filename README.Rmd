...
![Fig. Missingness plot showing the missing data per trait in black.](figures/5_missing_data_pre_clean.png){width=800px}
...
The dataset is read in and scaled, histograms of the variables for each trait are plotted and log-transformed if appropriate. The data is saved as an RDS.
...
Examines the correlation between traits in the dataset. First Kendall's [distance](https://en.wikipedia.org/wiki/Kendall_tau_distance) (a ranked metric) is calculated pairwise among each trait. Traits are plotted pairwise to examine their relationships visually. 
...
![Fig. Scatterplot of PCOA where each point indicates a species.](./figures/8_scatterplot_pcoa_density_polygon.png){width=800px}

The relative eigenvalues indicate the proportion of variation each axis explains.

![Fig. Relative eigenvalues of each PCOA axis.](./figures/8_barplot_relative_eigenvalues_pcoa.png){width=400px}
...
![Fig. Influence of number of dimensions on the quality of trait space.](./figures/9_dimensionality_no_axes.png){width=600px}
...
![Fig. Dendogram made from the Ward.d2 method of clustering](./figures/11_dendrograms_ward2_coloured_by_cluster.png){width=400px}

To understand the appropriate number of clusters for the data and method, a [helper script](https://github.com/divers-it/rs-traitspace/tree/main/R/cstats.table.R) is used to provide some statistics about the qualities of different clusters, up to seven. 
...
![Fig. The relative proportion for qualitative traits across clusters (k = 3)](./figures/11_stacked_barplots_wardD2_traits_by_cluster.png){width=600px}

![Fig. Quantitative traits across clusters (k = 3)](./figures/11_boxplots_wardD2_traits_by_cluster.png){width=600px}
...
knitr::include_graphics("./figures/11_scatterplot_pcoa_wardD2_k3_coloured_by_cluster.png")
```
...
knitr::include_graphics("./figures/11.1_scatterplot_pcoa_kpro_k5_coloured_by_cluster.png")
```
...
knitr::include_graphics("./figures/11.2_scatterplot_pcoa_pam_k3_coloured_by_cluster.png")
```
