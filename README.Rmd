...
![**Figure 3**. (a) One-hot traitspace with eigenvectors and (b) trait correlation matrix with dendrogram.](figures/figure_3_loadings.png){width=800px}
...
![**Figure 4**. Panel (a) shows PCoA with clustering where colours (k = 2) and shapes (k = 3) correspond to PAM clusters. Panel (b) shows UMAP plot see below) where shapes correspond to k = 3 clusters.](figures/figure_4_umap.png){width=800px}
