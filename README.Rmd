...
![Fig. Pairwise relationships between different traits](./figures/ggpairs.png){width=100%}
...
![Fig. PCOA plot coloured by clusters from the kprototypes approach (k = 4)](./figures/pcoa_kproto_k4.png)
...
![Fig. PCOA plot coloured by clusters from the PAM approach (k = 3](./figures/scatter_pcoa_pam_clusters.png)
...
![Fig. PCOA plot coloured by clusters from the PAM approach (k = 3](./figures/pcoa_LCM_k3.png)
