...
* implement the ordinal traits: (1) to take into account polymorphy, (2) to start with 'old' PROTEUS traits and order them based on what's in the data, including polymorphisms
...
* Are dimorphic species functionally less diverse than monomorphic species
* Are reproductive strategies of trees more diverse than those of herbs? 

This would involve removing e.g. reproductive traits or woodiness from the dataset, but would we also have to remove correlated traits like tree height?

* Look for unexpected correlations

* What about the gaps in trait space? where are dimorphic species lacking?
